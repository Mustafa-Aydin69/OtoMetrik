...
**OtoMetrik**,  platformlardan yüksek performanslı asenkron web kazıma teknikleriyle piyasa verilerini toplayan, temizleyen ve makine öğrenmesi modelleri için yapılandırılmış veri setlerine dönüştüren gelişmiş bir büyük veri hattı (Data Pipeline) projesidir.
